        ...
        <header className="header-global">
          ...
          <div className="position-relative">
            <section className="section-hero section-shaped my-0">
              ...
              <div class="card-body"style={{display:this.state.mprView?'block':'none'}}>
              <div class="alert alert-primary alert-dismissible fade show" role="alert">
                <span class="alert-text">Total Premium for loan :</span>
              </div>
              <input class="form-control form-control-lg" type="text" placeholder="ETH  (4% MPR)" onChange={(e)=>{this.setState({collateralValue:e.target.value})}}/>
              <div className="btn-wrapper" style={{marginTop:'200px', cursor:'pointer'}} onClick={()=>{this.setState({collateral:false,loan:false, currency:true})}}>
              <a href="#" className="btn btn-primary btn-icon mb-3 mb-sm-0 m-5">
