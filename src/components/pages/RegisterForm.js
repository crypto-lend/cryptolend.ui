          ...
          >
            <div className="form-group d-flex">
              <div className="input-group input-group-merge mr-3">
                <input
                  ...
                  onChange={e => updateForm(formKeys.firstName, e.target.value)}
                  required
                />
              </div>
              <div className="input-group input-group-merge">
                <input
                  ...
                  type="text"
                  value={form.lastName}
                  onChange={e => updateForm(formKeys.lastName, e.target.value)}
                  required
                />
              </div>
            </div>
            ...
            <div className="text-center">
              <button
                ...
                onClick={() => checkValidity() && push("/register")}
              >
